 ...
 * ```
 */
export const getSprintsState = (state: State) => state.sprint;
 ...
 */
 export const getSprints = createSelector(getSprintsState, fromSprint.getSprints);
